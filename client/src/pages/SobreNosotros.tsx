          ...
          <section className="bg-white dark:bg-card-dark rounded-xl p-6 md:p-10 shadow-sm border border-[#f4f3f0] dark:border-elevated-dark">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
              ...
              <div className="flex flex-col items-center text-center gap-3 p-4">
                ...
                <p className="text-gray-500 dark:text-gray-400 text-sm">CEO & Co-fundador</p>
              </div>
              <div className="flex flex-col items-center text-center gap-3 p-4">
                <div className="w-20 h-20 rounded-full bg-primary/20 flex items-center justify-center">
                  <span className="material-symbols-outlined text-primary text-3xl">person</span>
                ...
                <h3 className="font-bold">Nombre Apellido</h3>
                <p className="text-gray-500 dark:text-gray-400 text-sm">CTO & Co-fundador</p>
              </div>
              <div className="flex flex-col items-center text-center gap-3 p-4">
                <div className="w-20 h-20 rounded-full bg-primary/20 flex items-center justify-center">
                  <span className="material-symbols-outlined text-primary text-3xl">person</span>
                ...
                <h3 className="font-bold">Nombre Apellido</h3>
                <p className="text-gray-500 dark:text-gray-400 text-sm">Directora de Marketing</p>
              </div>
            </div>
          </section>
