    ...
    <div className="bg-background-light dark:bg-background-dark font-display text-text-main dark:text-white overflow-x-hidden min-h-screen">
      ...
      <main className="w-full max-w-7xl mx-auto px-4 md:px-8 lg:px-12 py-6">
        ...
        <div className="flex items-center gap-2 text-sm text-text-secondary mb-6">
          ...
          <Link to="/talleres" className="hover:text-primary transition-colors">
            Talleres
          </Link>
          <span className="material-symbols-outlined text-[16px]">
            chevron_right
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="w-full aspect-video md:aspect-[21/9] bg-gray-200 rounded-xl overflow-hidden relative group">
              ...
              <div
                ...
                style={{
                  backgroundImage:
                    "url('https://lh3.googleusercontent.com/aida-public/AB6AXuBKGkaPdamBvs1x2BDKnqfK8cAlF5XUOKVIDMDaI3h4k0PKOz6esPo6Dipp8xqzTrH_gxr5FNjfvnkmiceJ_dgRqR4IR6PozsIupaLKdzg93FCThqrwlD8jKyc9A68JmdzYN8Na19NyXDAytaFt5lXUg6nChjcz1MrIybfSxBniOboWUTQ3DnCoSrkYLc4-OxdQxx1UGcvnqr-Xse-jOBE-aq3njLbRAO4YGIm3sH41IFsvPQlzYc47rtxdvUVMacAUNdcvgfsB1jYk')",
                }}
              ></div>
            ...
            <div>
              ...
              <p className="text-text-secondary leading-relaxed text-base">
                Somos un taller familiar con más de 15 años de experiencia en el
                barrio de Palermo. Nos especializamos en mecánica ligera,
                inyección electrónica y service oficial de marcas líderes.
                Contamos con scanner de última generación y stock permanente de
                repuestos originales para garantizar reparaciones rápidas y
                confiables. Nuestro compromiso es la transparencia: te mostramos
                los repuestos cambiados y explicamos cada paso del proceso.
              </p>
            </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                ...
                <div className="aspect-square rounded-lg bg-gray-200 overflow-hidden cursor-pointer hover:opacity-90 transition-opacity">
                  <div
                    ...
                    style={{
                      backgroundImage:
                        "url('https://lh3.googleusercontent.com/aida-public/AB6AXuCMOZaro7yOcB25c40v3Lu19Aot8-Xll3ZN7WjvwDPC82afpjU6vTfRFDDHXhv7XFI1ADUAWH5tEDzbvloZm8yRd7DsSfVVQbuGGm4WXvLCY3zfzfnv2WxTzB3Rcx8s1APQsfqx4PiWGMaOHoivf5Zy-G5UmKwjdW04D_YnbdCaIez_cEZjDvv1LHR0EhpdoNeZPuZoHsU3fMbKtiKh0mWrt_PaYngSJV_dpWemNHpT1n8UTmVZ_D9vFFlIMpjJdgK2NENtd4HQ6cuW')",
                    }}
                  ></div>
                </div>
                <div className="aspect-square rounded-lg bg-gray-200 overflow-hidden cursor-pointer hover:opacity-90 transition-opacity">
                  <div
                    ...
                    style={{
                      backgroundImage:
                        "url('https://lh3.googleusercontent.com/aida-public/AB6AXuC8K4G__33Cgb-xMQ0qmXSVK5KGrKIJVv40QHVMaiJi38RXm9pFckCe_vHVNeQupIQns4gLOURcq1rZ0DQpYDNyMfW_xpOusuG0w2lqb31Dx-75f4brkxX2LrcF54bQX-F6jl2mYNEhSmEehSWgU8-JzBMUiI6P-lLJqAMLd1B3WGXVor5tbgI9ZTDM_fvDePSKWDKCzVJl0VCBWd_xbkHf0h7AGY-m1nLj6kM912OvJZZEpefUI_C8VIlri8DAeg99QoT45gHPgD8v')",
                    }}
                  ></div>
                </div>
                <div className="aspect-square rounded-lg bg-gray-200 overflow-hidden relative cursor-pointer hover:opacity-90 transition-opacity">
                  <div
                    ...
                    style={{
                      backgroundImage:
                        "url('https://lh3.googleusercontent.com/aida-public/AB6AXuCUteo0zD4DKUlyGnNxifAcGIrHibMB63Tmh9CfhiJzVi0aeednLXGwwUY_zFOlGtjHCISr_DAdT48IOP-HQugi0IsjsztRfwukuOQT2akIgiismYeyvZOCJZWe86_QUXdPLBkdEOyD_eabIQlgFcSgIxTxN5f7rNNXy2WrE-FzvQULByWGU5YxM6Tl4kmHaOPJXUy2HceS_daFouBU0TjY9Ug7mv3RQMpvqEdvErpfuSXRKtg402jK822svoF7Ig1pyb5eYf-Gni3n')",
                    }}
                  ></div>
              ...
              <div className="space-y-6">
                ...
                <div className="border-b border-gray-100 dark:border-gray-800 pb-6">
                  ...
                  <p className="text-text-main dark:text-gray-300 text-sm mt-2">
                    Excelente atención. Fui por un problema de carburación en mi
                    GN125 y me lo solucionaron en el día. El precio me pareció
                    justo y me mostraron las piezas que cambiaron. Muy
                    recomendable.
                  </p>
                ...
                <div className="border-b border-gray-100 dark:border-gray-800 pb-6">
                  ...
                  <p className="text-text-main dark:text-gray-300 text-sm mt-2">
                    Buena atención, pero demoraron un poco más de lo prometido
                    en entregar la moto. El trabajo quedó impecable, eso sí.
                    Volvería a ir pero iría con más tiempo.
                  </p>
                  <div className="mt-3 bg-gray-50 dark:bg-gray-700/50 p-3 rounded-lg border-l-4 border-primary">
                    ...
                    <p className="text-xs text-text-secondary dark:text-gray-400">
                      Hola Sofía, lamentamos la demora. Tuvimos un retraso en la
                      entrega del repuesto original. Gracias por destacar la
                      calidad del trabajo, te esperamos para el próximo service
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-text-secondary">
                          Av. Corrientes 4532, Almagro, CABA.
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="w-full">
                        ...
                        <div className="text-sm text-text-secondary grid grid-cols-2 gap-x-2 gap-y-1">
                          ...
                          <span>Sábados:</span>{" "}
                          <span className="text-right">09:00 - 14:00</span>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-text-secondary mb-2">
                      Este taller cumple con nuestros estándares de calidad y
                      transparencia.
                    </p>
                    <a
